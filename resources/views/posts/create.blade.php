        ...
        <div class="md:w-1/2 p-10 bg-white rounded-lg shadow-xl mt-10 md:mt-0">
            <form action="{{route('posts.store')}}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="titulo" name="titulo" class="border p-3 w-full rounded-lg @error('titulo') border-red-500 @enderror" placeholder="Titulo de tu publicación" value="{{old('titulo')}}">
                    @error('titulo')
                ...
                <div class="mb-5">
                    ...
                    <textarea id="descripcion" name="descripcion" class="border p-3 w-full rounded-lg @error('descripcion') border-red-500 @enderror" placeholder="Descripción de tu publicación">{{old('descripcion')}}</textarea>
                    @error('descripcion')
                            <p class="bg-red-500 text-white my-2 rounded-lg p-2 text-sm text-center">{{$message}}</p>
                    @enderror
                </div>
